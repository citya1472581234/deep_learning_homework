...
tf.flags.DEFINE_string('converter_path', 'model/shakespeare/converter.pkl', 'model/name/converter.pkl')
tf.flags.DEFINE_string('checkpoint_path', 'model/shakespeare/', 'checkpoint path')
tf.flags.DEFINE_string('start_string', 'start', 'use this string to start generating')
